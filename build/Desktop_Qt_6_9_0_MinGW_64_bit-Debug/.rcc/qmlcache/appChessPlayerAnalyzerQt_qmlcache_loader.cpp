...
namespace _qt_qml_ChessPlayerAnalyzerQt_Main_qml { 
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appChessPlayerAnalyzerQt)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appChessPlayerAnalyzerQt))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appChessPlayerAnalyzerQt)() {
    return 1;
}
